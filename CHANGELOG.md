...
- Create, edit, duplicate, delete and reset AI commands with their own prompt, provider, model and result mode
...
- New or changed words are highlighted inline in the result, so you can see what the model did
